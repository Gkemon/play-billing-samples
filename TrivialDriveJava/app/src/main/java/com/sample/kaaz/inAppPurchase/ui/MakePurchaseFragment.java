...
import com.sample.kaaz.inAppPurchase.TrivialDriveRepository;
import com.sample.kaaz.inAppPurchase.databinding.FragmentMakePurchaseBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MakePurchaseViewModel.MakePurchaseViewModelFactory makePurchaseViewModelFactory =
                new MakePurchaseViewModel.MakePurchaseViewModelFactory(
                        ((InAppPurchaseApplication) getActivity().getApplication())
